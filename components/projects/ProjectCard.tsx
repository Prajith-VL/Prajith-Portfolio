...
export default function ProjectCard({ project, index }: Props) {
  return (
    <motion.article
      ...
      className="flex flex-col rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-transparent p-6 sm:p-8"
    >
      ...
      <a
        ...
        className="mt-6 inline-flex w-fit items-center gap-2 rounded-full border border-white/20 px-4 py-2 font-mono text-xs uppercase tracking-wider text-white transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
      >
