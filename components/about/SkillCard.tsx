...
export default function SkillCard({ title, items, index }: Props) {
  return (
    <motion.article
      ...
      className="group min-w-0 rounded-2xl border border-white/10 bg-white/[0.03] p-5 backdrop-blur-sm transition sm:p-6 hover:border-[var(--accent)]/40 hover:bg-[var(--accent-dim)]"
    >
